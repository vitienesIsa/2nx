...
File conversion requires
 $$R_{total} = \frac{(60 + n_{bin}) \cdot x \cdot y \cdot \frac{b}{8}}{1024^2} + 500 \text{ MB}$$ where
...
3. Install required packages: *pip install -r requirements.txt* or *conda install -r requirements.txt*. It is strongly recommended to set up and execute within a conda environment.
